...
const Register: React.FC = () => {
        ...
        return (
            <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-6 text-center">
                <div className="max-w-md w-full glass-pill py-12 px-8 flex flex-col items-center gap-6">
                    ...
                    <p className="text-white/60">Your journey to the crown begins now. We'll review your application and contact you via email soon.</p>
    ...
    return (
        <div className="min-h-screen bg-neutral-950 text-white py-24 px-6">
            <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24">
                {/* Info Column */}
                <div className="space-y-12">
                    <div className="flex flex-col gap-4">
                        <span className="text-gold-500 font-mono text-sm tracking-widest uppercase font-bold flex items-center gap-4">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10 group">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input name="phone" type="tel" value={formData.phone} onChange={handleChange} className="bg-transparent border-b border-white/10 py-4 focus:border-gold-500 outline-none transition-all placeholder:text-white/5" placeholder="+234 ..." />
                            </div>
                        </div>

                        <div className="flex flex-col gap-2">
                            <label className="text-[10px] uppercase tracking-[0.3em] font-black text-white/30">Talent Category</label>
                            <select name="talent_category" value={formData.talent_category} onChange={handleChange} className="bg-neutral-900 border border-white/10 p-4 focus:border-gold-500 outline-none transition-all appearance-none cursor-pointer">
